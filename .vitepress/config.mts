...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'search', link: '/zh/modules/search' },
      { text: 'data', link: '/zh/modules/data' },
      { text: 'trace', link: '/zh/modules/trace' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'cron-postgres', link: '/zh/drivers/cron-postgres' },
      { text: 'cron-redis', link: '/zh/drivers/cron-redis' },
      { text: 'search-file', link: '/zh/drivers/search-file' },
      { text: 'search-meilisearch', link: '/zh/drivers/search-meilisearch' },
      { text: 'search-opensearch', link: '/zh/drivers/search-opensearch' },
      { text: 'search-elasticsearch', link: '/zh/drivers/search-elasticsearch' },
      { text: 'data-postgres', link: '/zh/drivers/data-postgres' },
      ...
      { text: 'trace-file', link: '/zh/drivers/trace-file' },
      { text: 'trace-greptime', link: '/zh/drivers/trace-greptime' },
      { text: 'trace-otlp', link: '/zh/drivers/trace-otlp' },
...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'trace', link: '/en/modules/trace' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'cron-postgres', link: '/en/drivers/cron-postgres' },
      { text: 'cron-redis', link: '/en/drivers/cron-redis' },
      { text: 'search-file', link: '/en/drivers/search-file' },
      { text: 'search-meilisearch', link: '/en/drivers/search-meilisearch' },
      { text: 'search-opensearch', link: '/en/drivers/search-opensearch' },
      { text: 'search-elasticsearch', link: '/en/drivers/search-elasticsearch' },
      { text: 'data-postgres', link: '/en/drivers/data-postgres' },
      ...
      { text: 'trace-file', link: '/en/drivers/trace-file' },
      { text: 'trace-greptime', link: '/en/drivers/trace-greptime' },
      { text: 'trace-otlp', link: '/en/drivers/trace-otlp' },
